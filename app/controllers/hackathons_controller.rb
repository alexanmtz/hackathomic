class HackathonsController < ApplicationController
  ...
  private
    ...
    def hackathon_params
      params.require(:hackathon).permit(:name, :start, :ends, :location, :teams_id, :picture, :link, :languages, :frameworks, :github, :prize, :rules, :projects, :tags, :category, :user_id, :desc)
    end
end
